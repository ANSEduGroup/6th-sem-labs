...
ALTER TABLE room_028
ADD CONSTRAINT hotel_key_028
FOREIGN KEY (hotel_no) REFERENCES hotel_028(hotel_no);

-- For table booking, constraint is room_key, room_no and hotel_no are both foreign keys
-- Reference room table
ALTER TABLE booking_028
ADD CONSTRAINT room_key_028
FOREIGN KEY (room_no, hotel_no) REFERENCES room_028(room_no, hotel_no);

-- For table booking, constraint is guest_key, guest_no is the foreign key
-- Reference guest table
ALTER TABLE booking_028
ADD CONSTRAINT guest_key_028
FOREIGN KEY (guest_no) REFERENCES guest_028(guest_no);
